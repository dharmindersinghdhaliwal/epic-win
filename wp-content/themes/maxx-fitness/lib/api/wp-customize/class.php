 ...
 */
final class maxxfitness_tt_WP_Customize {
	...
	public function __construct( $section, $args ) {
		...
		maxxfitness_add_attribute( 'maxxfitness_field_label', 'class', 'customize-control-title' );
	...
	private function add() {
		...
		$fields = maxxfitness_get_fields( 'wp_customize', $this->section );
	...
	private function add_setting( $wp_customize, $field ) {
		...
		$wp_customize->add_setting(
			$field['name'],
			array(
				'default' => maxxfitness_get( 'default', $field ),
				'type' => $field['db_type'],
	...
	private function add_control( $wp_customize, $field ) {
		...
		$class = 'maxxfitness_tt_WP_Customize_Control';
...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 * @ignore
	 */
	class maxxfitness_tt_WP_Customize_Control extends WP_Customize_Control {
		...
		public function __construct() {
			...
			$this->maxxfitness_field = end( $args );
		...
		public function render_content() {
			...
			maxxfitness_field( $this->maxxfitness_field );
