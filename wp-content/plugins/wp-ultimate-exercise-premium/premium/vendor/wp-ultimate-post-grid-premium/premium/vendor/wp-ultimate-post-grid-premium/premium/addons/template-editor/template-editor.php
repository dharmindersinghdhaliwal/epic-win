...
class WPUPG_Etemplate_Editor extends WPUPG_Epremium_Addon {
            ...
            WPUltimateEPostEgrid::get()->helper( 'eassets' )->add(
                ...
                array(
                    ...
                    'data' => array(
                        ...
                        'ajax_url' => WPUltimateEPostEgrid::get()->helper('eajax')->url(),
                        'nonce' => wp_create_nonce( 'template_editor_preview' ),
                        'exercise' => intval($_GET['wpupg_template_editor_preview']),
                    )
                )
            );
    ...
    {
        if( isset( $_GET['wpupg_template_editor_preview'] ) && WPUPG_EPOST_TYPE == get_post_type( $_GET['wpupg_template_editor_preview'] ) )
        {
            $template = get_option( 'wpupg_custom_template_preview' );
        }
...
WPUltimateEPostEgrid::loaded_addon( 'template-editor', new WPUPG_Etemplate_Editor() );