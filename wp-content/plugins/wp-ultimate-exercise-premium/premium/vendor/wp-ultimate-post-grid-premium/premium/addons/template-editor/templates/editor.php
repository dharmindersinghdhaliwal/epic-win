...
<head>
    ...
    <title>WP Ultimate Post Egrid - Template Editor</title>
    <!--[if lt IE 9]>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            <div class="navbar-header">
                <span class="navbar-brand">WP Ultimate Post Egrid Template Editor</span>
            </div>
            ...
            <div id="panel-properties" class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <accordion close-others="true" ng-show="editingBlock!=null">
                        <accordion-group heading="Shorten Text" class="panel-info" properties="postTitle,postContent,postExcerpt">
                            <div class="form-group">
