...
<table id="wpupg_form_pagination" class="wpupg_form">
    ...
    <tr>
        <td><label for="wpupg_pagination_type"><?php _e( 'Type', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr class="wpupg_divider">
        <td><label for="wpupg_pagination_pages_posts_per_page"><?php _e( 'Posts per page', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr class="wpupg_divider">
        <td><label for="wpupg_pagination_load_more_initial_posts"><?php _e( 'Initial posts', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr>
        <td><label for="wpupg_pagination_load_more_posts_on_click"><?php _e( 'Posts loaded on click', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr>
        <td><label for="wpupg_pagination_load_more_button_text"><?php _e( 'Button text', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
