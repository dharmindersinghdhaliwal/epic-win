...
class WPUltimateEPostGridPremium {
    ...
    public function init()
    {
        ...
        // Include and instantiate WP Exercise Ultimate Post Grid
...
//        add_filter('plugin_action_links_wp-ultimate-post-grid-premium/wp-ultimate-post-grid-premium.php', array($this->wpupg->helper('plugin_action_link'), 'action_links'));
    }
...
if( class_exists( 'WPUltimateEPostGrid' ) ) {
    wp_die( __( "You need to deactivate the free WP Exercise Ultimate Post Grid plugin before activating the Premium version. You won't lose any settings or grids when deactivating.", 'wp-eultimate-post-grid' ), 'WP Exercise Ultimate Post Grid Premium', array( 'back_link' => true ) );
} else {
    // Instantiate WP Exercise Ultimate Post Grid Premium
