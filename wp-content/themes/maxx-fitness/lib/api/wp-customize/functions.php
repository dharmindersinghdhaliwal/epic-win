 ...
 */
function maxxfitness_register_wp_customize_options( array $fields, $section, $args = array() ) {
	 ...
	 */
	$fields = apply_filters( "maxxfitness_wp_customize_fields_{$section}", maxxfitness_tt_pre_standardize_fields( $fields ) );
	...
	if ( !maxxfitness_register_fields( $fields, 'wp_customize', $section ) )
		return false;

	// Load the class only if this function is called to prevent unnecessary memory usage.
	require_once( maxxfitness_API_PATH . 'wp-customize/class.php' );

	new maxxfitness_tt_WP_Customize( $section, $args );
