 ...
 * @package API\Image
 */
final class maxxfitness_tt_Image_Editor {
	...
	public function __construct( $src, array $args, $output = 'STRING' ) {
		...
		$this->args = $args;
		$this->output = $output;
		$local_source = maxxfitness_url_to_path( $this->src );
	...
	public function init() {
		...
		$src = maxxfitness_path_to_url( $this->rebuilt_path );
	...
	private function setup() {
		...
		$upload_dir = maxxfitness_get_images_dir();
