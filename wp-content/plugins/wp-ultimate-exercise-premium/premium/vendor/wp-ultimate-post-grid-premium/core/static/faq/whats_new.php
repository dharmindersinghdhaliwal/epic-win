<div class="changelog">
    <div>
        <p class="about-description">We keep working on WP Ultimate Post Egrid every single week. Find out what's new in our latest version.</p>
    </div>
    ...
    <div class="feature-section col two-col">
        <div class="col-1">
            <h3>WP Ultimate Post Egrid 1.6</h3>
            <strong>New</strong>
            <ul>
        ...
        <div class="col-2 last-feature">
            <h3>WP Ultimate Post Egrid Premium 1.6</h3>
            <strong>New</strong>
            <ul>
    ...
    <div>
        ...
        <ul>
            ...
            <li>Improvement: wpupg_eoutput_grid_html filter hook</li>
