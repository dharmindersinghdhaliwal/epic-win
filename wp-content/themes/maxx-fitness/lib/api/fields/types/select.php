...
maxxfitness_add_smart_action( 'maxxfitness_field_select', 'maxxfitness_field_select' );
 ...
 * }
 */
function maxxfitness_field_select( $field ) {

	if ( empty( $field['options'] ) )
		return;

	?>
	<select name="<?php echo esc_attr( $field['name'] ); ?>" <?php echo maxxfitness_esc_attributes( $field['attributes'] );?>>
