...
class WPUPG_Elicense {
    ...
    public function __construct()
    {
        ...
        define( 'EDD_WPUPG_PRODUCT', 'WP Ultimate Post Egrid Premium' );

        if( !class_exists( 'EDD_SL_Plugin_Updater' ) ) {
            include( WPUltimateEPostEgridPremium::get()->premiumDir . '/vendor/EDD/EDD_SL_Plugin_Updater.php' );
        }
    }

    public function license_notice()
    {
        if( get_current_screen()->id == WPUPG_EPOST_TYPE . '_page_wpupg_admin' ) {
            $license 	= get_option( 'edd_wpupg_license_key' );
            $status 	= get_option( 'edd_wpupg_license_status' );

            include( WPUltimateEPostEgridPremium::get()->premiumDir . '/helpers/license_form.php' );
        }
    }
    ...
    public function plugin_updater() {
        ...
        // setup the updater
        $edd_updater = new EDD_SL_Plugin_Updater( EDD_WPUPG_STORE_URL, WPUltimateEPostEgrid::get()->pluginFile, array(
