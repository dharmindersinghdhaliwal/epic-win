...
while(true) {
    ...
    foreach( $posts as $post ) {
        ...
        WPUEP_Taxonomy_MetaData::set( 'ingredient', $term->slug, 'link', $link );
...
WPUltimateExercise::get()->helper( 'notices' )->add_admin_notice( '<strong>WP Ultimate Exercise</strong> ' . $message );