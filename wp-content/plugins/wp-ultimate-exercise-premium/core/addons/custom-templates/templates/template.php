...
class WPUEP_Template {
    ...
    public function output_string( $exercise, $type = 'exercise' )
    {
        if( is_string( $type ) ) {
            $args = array(
                'template_type' => $type,
        ...
        return $this->container->output( $exercise, $args );
    }

    public function output( $exercise, $type = 'exercise' )
    {
        echo $this->output_string( $exercise, $type );
    }
}