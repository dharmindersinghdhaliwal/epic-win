...
<style id="superfly-dynamic-styles">
    ...
    .sfm-navicon, .sfm-navicon:after, .sfm-navicon:before, .sfm-sidebar-close:before, .sfm-sidebar-close:after { height: <?php echo $line; ?>px !important;  }
    .sfm-label-square .sfm-navicon-button, .sfm-label-rsquare .sfm-navicon-button, .sfm-label-circle .sfm-navicon-button { border-width: <?php echo $line; ?>px !important;  }
    .sfm-vertical-nav .sfm-submenu-visible > a .sfm-sm-indicator i:after {
		-webkit-transform: rotate(180deg);-moz-transform: rotate(180deg);
		-ms-transform: rotate(180deg);-o-transform: rotate(180deg);	transform: rotate(180deg);	}
	#sfm-mob-navbar .sfm-navicon-button:after {	/*width: 30px;*/	}
	.sfm-pos-right .sfm-vertical-nav .sfm-has-child-menu > a:before {display: none;}
	#sfm-sidebar.sfm-vertical-nav .sfm-menu .sfm-sm-indicator {background: rgba(255,255,255,0.085);}
	.sfm-pos-right #sfm-sidebar.sfm-vertical-nav .sfm-menu li a {/*padding-left: 10px !important;*/}
	.sfm-pos-right #sfm-sidebar.sfm-vertical-nav .sfm-sm-indicator {left: auto;right: 0;}
.sfm-mobile #sfm-sidebar.sfm-compact-header .sfm-logo img {max-height: 75px;}
#sfm-sidebar.sfm-compact .sfm-nav {min-height: 50vh;height: auto;max-height: none;margin-top: 0px;}
#sfm-sidebar.sfm-compact-footer .sfm-social {margin-top: 30px;margin-bottom: 10px;position: relative;}
#sfm-sidebar.sfm-compact .sfm-sidebar-bg {min-height: 150%;}
...
.sfm-sidebar-slide.sfm-body-pushed .sfm-rollback { opacity: 0;}
<?php endif; ?>
...
<?php if($options['sf_highlight'] == 'semi-dark'): ?>
    #sfm-sidebar .sfm-menu li > a:before {background: rgba(0, 0, 0, 0.05) !important;}
    <?php endif; ?>
...
.sfm-search-form input {padding-<?php echo $options['sf_alignment']; ?>: 28px !important;}
#sfm-sidebar.sfm-compact  .sfm-social li {text-align: <?php echo $options['sf_alignment']; ?>;}
#sfm-sidebar.sfm-compact  .sfm-social:before {	right: auto;left: auto;
<?php echo $options['sf_alignment']; ?>: 10%;}
<?php endif; ?>
#sfm-sidebar:after {display: none !important;}
<?php if ($options['sf_search'] == 'hidden'): ?>
#sfm-sidebar .search-form {display: none !important;}
<?php endif; ?>
...
.sfm-no-mobile #sfm-sidebar{display:block !important}
.sfm-no-mobile.sfm-pos-right body, .sfm-no-mobile.sfm-pos-right #wpadminbar {
	padding-right: <?php echo $panel1_adjusted; ?>px !important;box-sizing: border-box !important;}
#sfm-sidebar .sfm-rollback {/*display: none !important;*/}
...
#sfm-sidebar {/*z-index: 1;*/}
#sfm-sidebar .sfm-sidebar-bg, #sfm-sidebar .sfm-scroll-wrapper {opacity: 0 !important;}
#sfm-sidebar.sfm-sidebar-exposed .sfm-scroll-wrapper {opacity: 1 !important;}
#sfm-sidebar .sfm-social {background-color: transparent !important;}
#sfm-sidebar .sfm-widget,.sfm-menu li a{text-align: center !important;}
.sfm-nav form, .sfm-menu li img, #sfm-sidebar .sfm-chapter, .sfm-menu li br,#sfm-sidebar .sfm-menu li:after  {display: none !important;}
#sfm-sidebar.sfm-sidebar-exposed, .sfm-sidebar-bg, #sfm-sidebar .sfm-nav,  #sfm-sidebar .sfm-logo, #sfm-sidebar .sfm-social {width: 100%;}
.sfm-rollback {/*z-index: 3000002;*/}
.sfm-sidebar-close:before, .sfm-sidebar-close:after {background-color: <?php echo $color_panel_1; ?>;}
#sfm-sidebar {opacity: 0 !important; visibility: hidden; width: 100% !important;}
.sfm-body-pushed #sfm-sidebar { opacity: 1 !important; visibility: visible;}
.sfm-pos-left .sfm-rollback {left: 0;right: auto;}
.sfm-pos-right .sfm-rollback {left: auto;right: 0;}
.sfm-body-pushed #sfm-overlay, body[class*="sfm-view-pushed"] #sfm-overlay {
    opacity: 1 !important; background: <?php echo $options['sf_fade_full']?> !important;}
#sfm-sidebar .sfm-menu li > a:before {
	-webkit-transition: none;	-moz-transition: none;	-o-transition: none;
	transition: none;background: <?php echo $color_panel_1?>;
}
#sfm-sidebar .sfm-menu li a {padding-left: 5px !important;padding-right: 5px !important;}
#sfm-sidebar .sfm-menu li:hover > a {color: #fff !important;}
<?php endif; ?>
...
#sfm-sidebar {font-family: <?php echo $font; ?>;}
#sfm-sidebar .sfm-sm-indicator {line-height: <?php echo $options['sf_font_size'];?>px;}
#sfm-sidebar .sfm-search-form input {font-size: <?php echo $options['sf_font_size']; ?>px;}
...
#sfm-sidebar .sfm-menu-level-0 li .sfm-sm-indicator i,#sfm-sidebar .sfm-menu-level-0 .sfm-sl, .sfm-title h2, .sfm-social:after {
    ...
    .sfm-menu-level-0 .sfm-chapter { color: <?php echo $options['sf_chapter_1']; ?> !important; }    .sfm-menu-level-1 .sfm-chapter { color: <?php echo $options['sf_chapter_2']; ?> !important; }    .sfm-menu-level-2 .sfm-chapter { color: <?php echo $options['sf_chapter_3']; ?> !important; }    .sfm-menu-level-3 .sfm-chapter { color: <?php echo $options['sf_chapter_4']; ?> !important; }
#sfm-sidebar .sfm-view-level-1 li a,
#sfm-sidebar .sfm-menu-level-1 li a{
	color: <?php echo $color_panel_2; ?>;
	border-color: <?php echo $color_panel_2; ?>;
}
#sfm-sidebar:after {background-color: <?php echo $bg_color_panel_1; ?>;}
...
.sfm-navicon-button {top: <?php echo $options['sf_label_top'] ?>;}
.sfm-mobile .sfm-navicon-button {	top: <?php echo $options['sf_label_top_mobile'] ?>;}

	<?php if($options['sf_sidebar_pos'] == 'left'): ?>
.sfm-navicon-button {
	left: <?php echo $options['sf_label_shift'] ?> !important;;
}
.sfm-mobile .sfm-navicon-button {left: inherit;}
<?php endif; ?>
...
.sfm-mobile .sfm-navicon-button {	right: inherit;}
<?php endif; ?>
...
#sfm-sidebar .sfm-menu li:after {
	...
	position: absolute;
	bottom: 0px;left: 0;right: 0;	height: 1px;
...
<?php endif; ?>
.sfm-style-skew #sfm-sidebar .sfm-social{height: auto;/*min-height: 75px;*/}
...
#sfm-sidebar [class*="sfm-icon-"] {color: <?php echo $options['sf_social_color']; ?>;}
#sfm-sidebar .sfm-social li {border-color: <?php echo $options['sf_social_color']; ?>;}
#sfm-sidebar .sfm-social a {color: <?php echo $options['sf_social_color']; ?>;}
#sfm-sidebar .sfm-search-form {background-color: <?php echo $searchbg; ?>;}
@font-face {
...
<?php if( $options['sf_mob_nav'] === 'yes' ): ?>
	@media screen and (max-width: <?php echo $options['sf_threshold_point'];?>px) {
		#sfm-mob-navbar  {
			display: none;height: 62px;width: 100%;-webkit-backface-visibility: hidden;position: fixed;
			top: 0;left: 0;z-index: 999999;text-align: center;
		...
		.sfm-navicon-button:after {font-size: 18px !important;}
	}
	<?php endif; ?>
