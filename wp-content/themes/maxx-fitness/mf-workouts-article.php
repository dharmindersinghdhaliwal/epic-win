<?php
/*
Template Name: MaxxFitness Workouts Article
*/
        ...
        <div class="uk-width-medium-1-1">
            <?php while (have_posts()) : the_post(); ?>
                <article <?php post_class('uk-article'); ?> data-permalink="<?php the_permalink(); ?>">
                    ...
                    <div class="tm-page-workouts">
                        <?php $pieces = get_extended($post->post_content); ?>
                        <?php echo apply_filters('the_content',$pieces['extended']);?>
                    </div>
