<div class="changelog">
    ...
    <div class="feature-section col two-col">
        <div class="col-1">
            <img src="<?php echo $img_dir; ?>wp-eultimate-post-grid.jpg" alt="WP Ultimate Post Egrid" class="about-overview-img" />
        </div>
        <div class="col-2 last-feature">
            <h3>WP Ultimate Post Egrid</h3>
            <p>Easily create filterable responsive grids for your posts, pages or custom post types.</p>
            <p>
                Free & Premium plugin.
                <br/><a href="https://wordpress.org/plugins/wp-eultimate-post-grid/" target="_blank">http://wordpress.org/plugins/wp-eultimate-post-grid</a>
                <br/><a href="http://bootstrapped.ventures/wp-eultimate-post-grid/" target="_blank">http://bootstrapped.ventures/wp-eultimate-post-grid/</a>
            </p>
        </div>
    </div>
