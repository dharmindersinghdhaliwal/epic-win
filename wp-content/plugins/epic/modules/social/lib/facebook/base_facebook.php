 ...
 */
class epic_FacebookApiException extends Exception
{
  /**
 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class epic_BaseFacebook
{
  /**
   * Version.
   */
  ...
  public function setExtendedAccessToken() {
    ...
    catch (epic_FacebookApiException $e) {
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new epic_FacebookApiException(array(
  ...
  protected function throwAPIException($result) {
    $e = new epic_FacebookApiException($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
