...
class Sensei_Lesson {
	...
	public function quiz_panel_add( $context = 'quiz' ) {
		...
		if( 'quiz' == $context ) {
			...
			$html .= '<div id="existing-filters" class="alignleft actions"><select id="existing-status"><option value="all">' . esc_html__( 'All', 'woothemes-sensei' ) . '</option><option value="unused">' . esc_html__( 'Unused', 'woothemes-sensei' ) . '</option><option value="used">' . esc_html__( 'Used', 'woothemes-sensei' ) . '</option></select><select id="existing-type"><option value="">' . esc_html__( 'All Types', 'woothemes-sensei' ) . '</option>';
	    	
	    	foreach ( $question_types as $type => $label ) {
				$html .= '<option value="' . esc_attr( $type ) . '">' . esc_html( $label ) . '</option>';
			}
    		
    		$html .= '</select><select id="existing-category"><option value="">' . esc_html__( 'All Categories', 'woothemes-sensei' ) . '</option>';

			foreach( $question_cats as $cat ) {
				$html .= '<option value="' . esc_attr( $cat->slug ) . '">' . esc_html( $cat->name ) . '</option>';
			}
    		
    		$html .= '</select><input type="text" id="existing-search" placeholder="' . esc_attr__( 'Search', 'woothemes-sensei' ) . '" /><a class="button" id="existing-filter-button">' . esc_html__( 'Filter', 'woothemes-sensei' ) . '</a></div>';

			$html .= '<table id="existing-table" class="widefat">';
			$html .= '<thead><tr><th scope="col" class="column-cb check-column"><input type="checkbox" /></th><th scope="col">' . esc_html__( 'Question', 'woothemes-sensei' ) . '</th><th scope="col">' . esc_html__( 'Type', 'woothemes-sensei' ) . '</th><th scope="col">' . esc_html__( 'Category', 'woothemes-sensei' ) . '</th></tr></thead><tfoot><tr><th scope="col" class="check-column"><input type="checkbox" /></th><th scope="col">' . esc_html__( 'Question', 'woothemes-sensei' ) . '</th><th scope="col">' . esc_html__( 'Type', 'woothemes-sensei' ) . '</th><th scope="col">' . esc_html__( 'Category', 'woothemes-sensei' ) . '</th></tr></tfoot>';
