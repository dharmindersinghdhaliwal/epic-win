...
class WPUPG_Evafpress_Menu {
    ...
    {
        require_once( WPUltimateEPostEgrid::get()->coreDir . '/helpers/vafpress/vafpress_menu_whitelist.php');
        require_once( WPUltimateEPostEgrid::get()->coreDir . '/helpers/vafpress/vafpress_menu_options.php');
