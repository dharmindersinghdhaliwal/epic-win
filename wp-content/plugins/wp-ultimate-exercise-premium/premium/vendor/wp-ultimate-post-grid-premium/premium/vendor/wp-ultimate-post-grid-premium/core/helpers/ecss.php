...
class WPUPG_Ecss {
    ...
    public function dropdown_filters_css()
    {
        if( WPUltimateEPostEgrid::is_premium_active() ) {
            $border_color               = WPUltimateEPostEgrid::option( 'filters_dropdown_border_color', '#AAAAAA' );
            $text_color                 = WPUltimateEPostEgrid::option( 'filters_dropdown_text_color', '#444444' );
            $background_highlight_color = WPUltimateEPostEgrid::option( 'filters_dropdown_highlight_background_color', '#5897FB' );
            $text_highlight_color       = WPUltimateEPostEgrid::option( 'filters_dropdown_highlight_text_color', '#FFFFFF' );
    ...
    {
        if( WPUltimateEPostEgrid::option( 'custom_code_public_css', '' ) !== '' ) {
            echo '<style type="text/css">';
            echo WPUltimateEPostEgrid::option( 'custom_code_public_css', '' );
            echo '</style>';
        }
    }
}