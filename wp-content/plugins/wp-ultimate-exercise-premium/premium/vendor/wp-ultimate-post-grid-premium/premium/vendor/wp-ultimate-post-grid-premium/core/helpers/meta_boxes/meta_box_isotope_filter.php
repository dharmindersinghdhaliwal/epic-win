...
<div id="wpupg_filter_preview_isotope_filter_style" class="wpupg_filter_preview">
    <div class="wpupg-filter-isotope-term" id="wpupg_isotope_filter_style_all_button_text_preview"><?php _e( 'All', 'wp-eultimate-post-grid' ); ?></div>
    <div class="wpupg-filter-isotope-term"><?php _e( 'A Tag', 'wp-eultimate-post-grid' ); ?></div>
    <div class="wpupg-filter-isotope-term active"><?php _e( 'This is Active', 'wp-eultimate-post-grid' ); ?></div>
    <div class="wpupg-filter-isotope-term"><?php _e( 'Example', 'wp-eultimate-post-grid' ); ?></div>
    <div class="wpupg-filter-isotope-term"><?php _e( 'Preview', 'wp-eultimate-post-grid' ); ?></div>
</div>
