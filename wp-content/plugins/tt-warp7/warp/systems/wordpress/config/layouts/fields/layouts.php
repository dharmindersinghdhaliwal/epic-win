                ...
                <li>
                    <label>
                        <input 
                            ...
                            name="<?php echo "{$name}[{$layout}][assignment][]" ?>" 
                            type="checkbox"<?php if(isset($layouts[$layout]['assignment'])){ if( @in_array($value, $layouts[$layout]['assignment']) ){ echo ' checked="checked"'; } } ?>>
                            <?php echo $text ?>
                    </label>
                <?php endforeach ?>
                </ul>
