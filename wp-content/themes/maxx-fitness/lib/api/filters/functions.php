 ...
 */
function maxxfitness_add_filter( $id, $callback, $priority = 10, $args = 1 ) {

	if ( is_callable( $callback ) )
		return add_filter( $id, $callback, $priority, $args );

	return maxxfitness_tt_add_anonymous_filter( $id, $callback, $priority, $args );
 ...
 */
function maxxfitness_apply_filters( $id, $value ) {
 ...
 *                  return value.
 */
function maxxfitness_has_filters( $id, $callback = false ) {
 ...
 * @ignore
 */
function maxxfitness_tt_add_anonymous_filter( $id, $callback, $priority = 10, $args = 1 ) {

	require_once( maxxfitness_API_PATH . 'filters/class.php' );

	new maxxfitness_tt_Anonymous_Filters( $id, $callback, $priority, $args );
