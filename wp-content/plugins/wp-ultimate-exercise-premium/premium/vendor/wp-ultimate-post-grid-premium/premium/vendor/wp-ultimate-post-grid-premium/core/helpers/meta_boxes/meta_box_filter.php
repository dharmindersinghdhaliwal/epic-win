...
<table id="wpupg_form_filter" class="wpupg_form">
    <tr class="wpupg_no_filter">
        <td><label for="wpupg_filter_type"><?php _e( 'Type', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr class="wpupg_divider">
        <td><label for="wpupg_filter_taxonomy_post"><?php _e( 'Taxonomy', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
            <?php
            ...
            foreach( $post_types as $post_type => $options ) {
                ...
                if( count( $taxonomies ) > 0 ) {
                    $multiple = WPUltimateEPostEgrid::is_premium_active() ? ' multiple' : '';
    ...
    <tr>
        <td><label for="wpupg_filter_match_parents"><?php _e( 'Selecting parent terms matches children', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr class="wpupg_divider">
        <td><label for="wpupg_filter_multiselect"><?php _e( 'Multi-select', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr>
        <td><label for="wpupg_filter_multiselect_type"><?php _e( 'Multi-select Behaviour', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
