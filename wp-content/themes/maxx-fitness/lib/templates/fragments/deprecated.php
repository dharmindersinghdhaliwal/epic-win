 ...
 * @deprecated 1.2.0
 */
function maxxfitness_head_title() {
 ...
 */
function maxxfitness_wp_title( $title, $sep ) {
	...
	if ( $paged >= 2 || $page >= 2 )
		$title .= " $sep " . sprintf( esc_html__( 'Page %s', 'maxx-fitness' ), max( $paged, $page ) );
...
$shortcode_tags = array_merge( $shortcode_tags, array(
	'maxxfitness_post_meta_date' => 'maxxfitness_post_meta_date_shortcode',
	'maxxfitness_post_meta_author' => 'maxxfitness_post_meta_author_shortcode',
	'maxxfitness_post_meta_comments' => 'maxxfitness_post_meta_comments_shortcode',
	'maxxfitness_post_meta_tags' => 'maxxfitness_post_meta_tags_shortcode',
	'maxxfitness_post_meta_categories' => 'maxxfitness_post_meta_categories_shortcode'
) );