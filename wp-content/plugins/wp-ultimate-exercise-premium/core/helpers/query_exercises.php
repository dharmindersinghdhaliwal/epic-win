    ...
    public function get()
    {
        ...
        if( $this->order_by == 'rating' ) {
            ...
            if( WPUltimateExercise::is_addon_active( 'user-ratings' ) && WPUltimateExercise::option( 'user_ratings_enable', 'everyone' ) != 'disabled' ) {
                $args['meta_key'] = 'exercise_user_ratings_rating';
            } else {
                $args['meta_key'] = 'exercise_rating';
            }
        }
        ...
        if( $query->have_posts() ) {
            ...
            foreach( $posts as $post ) {
                $exercises[] = new WPUEP_Exercise( $post );
            }
        }
