...
# Original  wp_set_object_terms($post_id, $module_id, $this->taxonomy, false);			
           wp_set_object_terms_custom($post_id, $module_id, $this->taxonomy, false);
        ...
        <div id="taxonomy-<?php echo $tax_name; ?>" class="categorydiv">
            ...
            <div id="<?php echo $tax_name; ?>-pop" class="tabs-panel" style="display: none;">
                <ul id="<?php echo $tax_name; ?>checklist-pop" class="categorychecklist form-no-clear" >
                    ...
                    //echo '<pre>'; print_r( $popular_ids ); exit;
                    ?>
                </ul>
            </div>
            ...
            <div id="<?php echo $tax_name; ?>-all" class="tabs-panel">
                ...
                <ul id="<?php echo $tax_name; ?>checklist" data-wp-lists="list:<?php echo $tax_name; ?>" class="categorychecklist form-no-clear">
                    <?php
                    wp_terms_checklist( array( 'taxonomy'=>$tax_name ) );
                    /*
...
function wp_set_object_terms_custom( $object_id, $terms, $taxonomy, $append = false ) {
	global $wpdb;
	...
	if ( ! $append )
		...
		if ( ! $append ) {
			...
			foreach($old_tt_ids as $old_tt_id){
				$temp_tt_ids[]	=  $old_tt_id->term_id;		
			}
			$delete_tt_ids = array_diff($temp_tt_ids,$tt_ids );
