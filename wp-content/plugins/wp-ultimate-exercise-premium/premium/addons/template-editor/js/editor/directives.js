        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                scope.$watch('template.blocks['+attrs.id+']', function() {
                    ...
                    // Custom Field Key
                    var exerciseCustomFieldKey = scope.getPropVal(attrs.id, 'exerciseCustomFieldKey')
                    ...
                    // Custom Field Key
                    if(exerciseCustomFieldKey) {
                        text = exerciseCustomFieldKey + ' (Custom Field)'
                        tag = 'span'
                    }
        ...
        return {
            ...
            link: function(scope, element, attrs, ngModel) {
                scope.openImageManager = function() {
                    window.wpuep_image_manager = function(url, width, height) {
                    ...
                    window.open('../../../../../../../wp-admin/edit.php?post_type=exercise&page=wpuep_image_manager');
                }
            },
            replace: true
        };
