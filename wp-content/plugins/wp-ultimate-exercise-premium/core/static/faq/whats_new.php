<div class="changelog">
    <div>
        <p class="about-description">We keep working on WP Ultimate Exercise every single week. Find out what's new in our latest version.</p>
    </div>
    ...
    <div class="feature-section col two-col">
        ...
        <div class="col-2 last-feature">
            <h3>WP Ultimate Exercise Premium 2.4</h3>
            <strong>New</strong>
            <ul>
                <li>Feature: Tooltip for Favorite Exercise button</li>
                <li>Feature: Tooltip for Add to Shopping List button</li>
                <li>Feature: Setting to show ingredient notes in shopping list</li>
                <li>Feature: Ability to show images in Exercise List Widget</li>
                <li>Feature: Setting to enable delete button for saved User Menus</li>
                <li>Feature: Setting to include list of exercises in the printed shopping list</li>
                <li>Feature: Custom Tag Conditions in the Template Editor</li>
                <li>Feature: Ability to list exercises submitted by current user in the Extended Exercise Index shortcode</li>
                <li>Feature: Exercise Date block in the Template Editor</li>
                ...
                <li>Improvement: Add to Shopping List button will only add a exercise once and indicate if it’s already on the list</li>
    ...
    <div>
        ...
        <ul>
            ...
            <li>Feature: Allow logged in users to edit their own exercises from the front end with a new shortcode</li>
            <li>Feature: Allow visitors to preview exercises in the User Submission form</li>
        ...
        <ul>
            <li>Feature: Full text search for exercises</li>
            <li>Feature: New partner integration with Chicory</li>
            <li>Setting: What to use for the exercise image title tag</li>
            <li>Fix: Password Protection now hides the exercise box as well</li>
        ...
        <ul>
            <li>Feature: Entire new Exercise Egrid functionality</li>
            ...
            <li>Fix: Exercise Egrid WordPress 4.2 compatibility</li>
        ...
        <ul>
            ...
            <li>Fix: Exercise Template compatibility with Twenty Fifteen theme</li>
        </ul>

        <h4>Premium Plugin 2.2.2</h4>
        <ul>
            <li>Feature: Favorite Exercies</li>
            <li>Improvement: Better exercise dropdown for Nutritional Information page</li>
            ...
            <li>Improvement: Import all exercises from other plugins, not just the published ones</li>
            <li>Fix: Problem with sub field conditions in tables, rows and columns</li>
            <li>Fix: XML import problem when importing multiple exercises with different fields</li>
        </ul>
        ...
        <ul>
            ...
            <li>Improvement: Exercise Egrid filters follow order used in shortcode</li>
            <li>Improvement: Use "pending review" instead of "draft" for user submitted exercises</li>
            <li>Improvement: New default User Menu name</li>
            <li>Improvement: Setting to disable Nutritional Information notice</li>
            <li>Improvement: Better way of saving custom exercise templates</li>
        ...
        <ul>
            ...
            <li>Improvement: Memory use of exercise templates</li>
        ...
        <ul>
            ...
            <li>Feature: Export your exercises to XML</li>
            <li>Feature: Import exercises from XML</li>
            ...
            <li>Fix: Metadata not shown in Exercise Egrid or print version</li>
        ...
        <ul>
            <li>Feature: Import from ExerciseCard by Yumprint</li>
        ...
        <ul>
            <li>Feature: Add to Shopping List from Exercise</li>
            ...
            <li>Feature: Custom HTML to display after a user has submitted a exercise</li>
            <li>Feature: Setting to hide specific category or tag terms on the User Submission page</li>
            <li>New hook: wpuep_exercise_grid_exercise_ids</li>
            <li>Fix: Number of exercises in Egrid when not displaying those without image</li>
        ...
        <ul>
            ...
            <li>Improvement: New default exercise and print template optimised for RTL languages</li>
            <li>Improvement: Ability to change sharing buttons language in the settings</li>
            <li>Improvement: Setting to disable the Exercise Archive page</li>
            <li>Fix: Issue when using decimal values as the serving size</li>
        </ul>

        <h4>Premium Plugin 2.1.2</h4>
        <ul>
            <li>Feature: Import from EasyExercise and EasyExercise Plus</li>
            <li>Improvement: List ZipList exercises that couldn’t be imported automatically</li>
            <li>Fix: NaN issue when calculating exercise nutritional information</li>
            <li>Fix: Exercise Search Widget when having a different site and home URL</li>
            <li>Fix: Exercise Egrid CSS issue with some themes</li>
        </ul>
        ...
        <ul>
            ...
            <li>Fix: Exercise Title will take over Post Title when intentionally left blank</li>
            <li>Fix: Memory issue for shortcode editor when having a large amount of exercises</li>
            <li>Fix: Improved CPU load should increase site speed</li>
        </ul>

        <h4>Premium Plugin 2.1.1</h4>
        <ul>
            <li>Feature: Import Ziplist exercises</li>
        ...
        <ul>
            ...
            <li>Setting: Hide custom tags from the Exercise Box</li>
            <li>Setting: Hide custom tags from User Submission</li>
            <li>Hook: wpuep_output_exercise_print_user_menus</li>
        ...
        <ul>
            ...
            <li>Setting: Output exercises in RSS Feed</li>
            <li>Improvement: Use alt and title tags as defined by user for instruction and exercise images</li>
            <li>Improvement: New icon for Shortcode Editor and settings</li>
            <li>Fix: Issue with saving settings</li>
            <li>Fix: Exercise Notes styling of hr tag and image alignment</li>
        ...
        <ul>
            <li>Improvement: Show exercise rating in metadata</li>
            <li>Setting: Use fractions after changing serving size</li>
            <li>Fix: Title tag for exercise instruction images</li>
        </ul>

        <h4>Premium Plugin 2.0.9</h4>
        <ul>
            <li>Feature: Ability to automatically crop exercise images in the Template Editor</li>
            ...
            <li>Fix: Exercise Search widget compatibility with some themes</li>
        </ul>
        <h4>Core Plugin 2.0.9</h4>
        <ul>
            <li>Fix: All dashes are now treated as ranges for calculations</li>
            <li>Fix: Exercise box for multipage posts</li>
            <li>Fix: Exercise_title metadata problem in some cases</li>
            <li>Fix: Exercise excerpt on archive pages</li>
        ...
        <ul>
            <li>Ability to change Exercise Tags, Ingredients and Instructions in the Template Editor</li>
            <li>New WPUEP Exercise Search widget</li>
            <li>New WPUEP Exercise List widget</li>
            <li>Import from Text is now available to anyone who is allowed to edit posts, not just administrators</li>
            <li>Ability to pick a template in the Exercise Egrid shortcode</li>
            ...
            <li>New hook: wpuep_user_menus_form</li>
        </ul>
        <h4>Core Plugin 2.0.8</h4>
        <ul>
            <li>Fixed CSS and JS problem on settings page for some users</li>
            <li>Fixed exercise metadata</li>
            <li>New hook: wpuep_query_posts_loop_check</li>
            <li>New hook: wpuep_exercise_content_loop_check</li>
        </ul>
        ...
        <ul>
            ...
            <li>Sharing buttons should now work in the Exercise Egrid</li>
            <li>Ability to change RSS feed template in the Template Editor</li>
            <li>Group by category or tag in the Extended Exercise Index shortcode</li>
        </ul>
        ...
        <ul>
            ...
            <li>New hook: wpuep_check_for_shortcode</li>
        </ul>
        ...
        <ul>
            ...
            <li>New hook: wpuep_user_submissions_form</li>
            <li>New hook: wpuep_register_menu_post_type</li>
        </ul>
        <h4>Core Plugin 2.0.6</h4>
        <ul>
            <li>Translation updates</li>
            <li>Fix for exercise thumbnail resizing in some themes</li>
            <li>Fixed metadata</li>
            <li>Sharing buttons overflow fix</li>
            <li>Updated VafPress to latest version</li>
            <li>Improved Exercise Notes styling</li>
            <li>RTL support on exercise print page</li>
            <li>New hook: wpuep_query_posts</li>
        </ul>
        ...
        <ul>
            ...
            <li>Improved Exercise Egrid: faster and AJAX load. Possibility to limit exercises shown on first page.</li>
            <li>Moved Exercise Egrid settings to shortcode.</li>
        </ul>
        ...
        <ul>
            ...
            <li>Fix for recalculating Exercise Egrid terms</li>
            <li>Easier to change font size in Template Editor</li>
            <li>New Exercise Link block in Template Editor</li>
        ...
        <ul>
            ...
            <li>Exercise Index fix for non-latin letters</li>
        </ul>

        <h4>Premium Plugin 2.0</h4>
        <ul>
            <li>No more need for the core plugin to use WP Ultimate Exercise Premium</li>
            <li>New <strong>Template Editor</strong> allows you to create and adjust exercise, print and exercise grid templates in a user-friendly interface</li>
            <li>Choose the template you want when inserting exercises with the shortcode</li>
            <li>Support for multiple Exercise Egrids on a single page</li>
            <li>Improved Exercise Egrid speed</li>
            <li>Sort Exercise Egrid by Exercise Rating</li>
            ...
            <li>Ability to <strong>clone exercises</strong> from the exercise overview page</li>
        </ul>
        ...
        <ul>
            ...
            <li>Demo Exercise included to show the correct way of entering exercises</li>
            <li>Added setting to add Exercise Shortcode Editor to other custom post types</li>
            <li>Possibility to adjust the mobile breakpoint, based on exercise box width</li>
            <li>Advanced setting to remove the exercise slug in URLs</li>
        </ul>
        ...
        <ul>
            ...
            <li>Fix: Exercies respect the more tag now</li>
        </ul>
        <h4>Core Plugin 1.0.11</h4>
        <ul>
            <li>Ability to add custom CSS from the exercise settings.</li>
        </ul>
        <h4>Premium Plugin 1.0.8</h4>
        <ul>
            <li>Customize the print template (add your own logo!)</li>
            <li>Import plain text exercises (beta version)</li>
        ...
        <ul>
            ...
            <li>Fix: Logged in users can now use the modal when submitting exercises</li>
        </ul>
        <h4>Premium Plugin 1.0.6</h4>
        <ul>
            <li>Extended shortcode options for the Exercise Egrid. For example: show the grid for 1 specific category.</li>
            <li>Fix: User conversion should work better in some specific cases</li>
        </ul>
        <h4>Core Plugin 1.0.9</h4>
        <ul>
            <li>Free text field for exercise times. You're not limited to minutes anymore.</li>
        ...
        <ul>
            ...
            <li>Fix: Only show tags and categories that actually have exercises in the Exercise Egrid</li>
        </ul>
        <h4>Core Plugin 1.0.8</h4>
        <ul>
            <li>Exercies now support Jetpack Publicize feature</li>
        ...
        <ul>
            <li>Multiselect for the Exercise Egrid</li>
        </ul>
        <h4>Core Plugin 1.0.7</h4>
        <ul>
            <li>Fix: Schema.org/Exercise format: added author and fixed whitespaces</li>
            <li>Fix: Share buttons layout</li>
            <li>Fix: Migration error</li>
            <li>Fix: Exercise Notes newlines</li>
        </ul>
        <h4>Premium Plugin 1.0.3</h4>
        <ul>
            <li>Convert between Imperial and Metric units</li>
            <li>List all exercises by author</li>
        </ul>
        <h4>Core Plugin 1.0.6</h4>
        <ul>
            <li>Fix: Exercise notes newlines work nows</li>
            <li>Fix: AutoSuggest ingredient should hide now</li>
            <li>Fix: Exercies as posts integration fixes</li>
        </ul>
        <h4>Premium Plugin 1.0.1</h4>
        <ul>
            <li>Draw attention to the possibility to vote for exercises</li>
            <li>Exercise Egrid included in shortcode editor</li>
        </ul>
        <h4>Core Plugin 1.0.1</h4>
        <ul>
            <li>Use your exercises just like normal posts</li>
            <li>Contact support directly from Exercise Admin page</li>
            <li>General Bug Fixes</li>
        </ul>
        <h4>Premium Plugin 1.0.0</h4>
        <ul>
            <li>Custom ingredient links (great for affiliate marketing)</li>
            <li>Let your users rate your exercises</li>
        ...
        <ul>
            ...
            <li>Shareable exercises (Facebook, Twitter, Google Plus & Pinterest)</li>
        </ul>
        <h4>Core Plugin 0.0.22</h4>
        <ul>
            <li>Use the default WP categories and tags for your exercises (see General Settings)</li>
        ...
        <ul>
            <li>Ability to import ReciPress exercises</li>
        </ul>
        <h4>Core Plugin 0.0.21</h4>
        <ul>
            <li>New exercise admin page (the one you're looking at!)</li>
