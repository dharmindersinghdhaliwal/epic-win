 ...
 */
    .controller('TemplateEditorCtrl', function($scope, $location, $timeout, $http, $sce, $compile, $modal, $filter) {
        ...
        $scope.previewTypeOptions = [{
            id: 'exercise', name: 'Exercise Template' },{
            //id: 'print', name: 'Print Template' },{
            id: 'grid', name: 'Exercise Egrid Template' }
        ];
                        ...
                        var addToCanvas = function(inCanvas, data, id) {
                            if(jQuery.inArray(id, inCanvas) == -1) {
                                ...
                                if(blocktype != 'container') {
                                    var droppableBlockTypes = ['rows', 'columns', 'table', 'box', 'exerciseTags', 'exerciseIngredients', 'exerciseIngredientContainer', 'exerciseInstructions', 'exerciseInstructionContainer'];
                                    var block = '';
                                    var parent = '';
        ...
        $scope.blockDefaults = function(block) {
            ...
            switch (block['type']) {
                ...
                case 'exerciseInstructions':
                    block['showGroups'] = block['showGroups'] || 'all'
                    block['exerciseInstructionsImages'] = block['exerciseInstructionsImages'] !== undefined ? block['exerciseInstructionsImages'] : true
                    block['text'] = block['text'] || '&nbsp;'
                    break;
                case 'title':
                ...
                case 'code':
                    ...
                    block['text'] = block['text'] || '';
                    break;
                case 'exerciseInstructionImage':
                    block['placeholder'] = block['placeholder'] || 'Exercise Instruction Image';
                case 'exerciseImage':
    ...
    .controller('ModalConditionsCtrl', function($scope, $modalInstance, block, conditions) {
        ...
        $scope.fieldOptions = [{
            id: 'exercise_image', name: 'exercise image' },{
            id: 'exercise_post_content', name: 'exercise post content' },{
            id: 'exercise_title', name: 'exercise title' },{
            id: 'exercise_description', name: 'exercise description' },{
            id: 'exercise_rating', name: 'exercise rating' },{
            id: 'exercise_servings', name: 'exercise servings' },{
            id: 'exercise_servings_type', name: 'exercise servings type' },{
            id: 'exercise_prep_time', name: 'exercise prep time' },{
            id: 'exercise_prep_time_text', name: 'exercise prep time unit' },{
            id: 'exercise_cook_time', name: 'exercise cook time' },{
            id: 'exercise_cook_time_text', name: 'exercise cook time unit' },{
            id: 'exercise_passive_time', name: 'exercise passive time' },{
            id: 'exercise_passive_time_text', name: 'exercise passive time unit' },{
            id: 'exercise_ingredients', name: 'exercise ingredients' },{
            id: 'exercise_instructions', name: 'exercise instructions' },{
            id: 'exercise_notes', name: 'exercise notes' },{
            id: 'exercise_nutrition_calories', name: 'calories' },{
            id: 'exercise_nutrition_carbohydrate', name: 'total carbohydrates' },{
            id: 'exercise_nutrition_protein', name: 'protein' },{
            id: 'exercise_nutrition_fat', name: 'total fat' },{
            id: 'exercise_nutrition_saturated_fat', name: 'saturated fat' },{
            id: 'exercise_nutrition_polyunsaturated_fat', name: 'polyunsaturated fat' },{
            id: 'exercise_nutrition_monounsaturated_fat', name: 'monounsaturated fat' },{
            id: 'exercise_nutrition_trans_fat', name: 'trans fat' },{
            id: 'exercise_nutrition_cholesterol', name: 'cholesterol' },{
            id: 'exercise_nutrition_sodium', name: 'sodium' },{
            id: 'exercise_nutrition_potassium', name: 'potassium' },{
            id: 'exercise_nutrition_fiber', name: 'dietary fiber' },{
            id: 'exercise_nutrition_sugar', name: 'sugars' },{
            id: 'exercise_nutrition_vitamin_a', name: 'vitamin A' },{
            id: 'exercise_nutrition_vitamin_c', name: 'vitamin C' },{
            id: 'exercise_nutrition_calcium', name: 'calcium' },{
            id: 'exercise_nutrition_iron', name: 'iron' }
        ];
        ...
        $scope.settingOptions = [{
            ...
            id: 'favorite_exercises_enabled', name: 'favorite exercise button' },{
            id: 'exercise_adjustable_servings', name: 'adjustable servings' },{
            id: 'exercise_adjustable_units', name: 'unit conversion' },{
            id: 'exercise_sharing_enable', name: 'exercise sharing' },{
            id: 'exercise_linkback', name: 'link to plugin' },{
