...
class WPUEP_Template_Exercise_Instruction_Image extends WPUEP_Template_Block {

    public $editorField = 'exerciseInstructionImage';
    public $thumbnail;
    public $crop = false;

    public function __construct( $type = 'exercise-instruction-image' )
    {
    ...
    {
        if( !$this->output_block( $exercise, $args ) || !isset( $args['instruction_image'] ) || $args['instruction_image'] == '' ) return '';
        ...
        $title_tag = WPUltimateExercise::option( 'exercise_instruction_images_title', 'attachment' ) == 'attachment' ? esc_attr( get_the_title( $args['instruction_image'] ) ) : esc_attr( $description );
