...
<table id="wpupg_form_pagination_style_2" class="wpupg_form">
    <tr class="wpupg_divider">
        <td><span class="wpupg_label_prefix"><?php _e( 'Border', 'wp-eultimate-post-grid' ); ?></span><label for="wpupg_pagination_style_border_width"><?php _e( 'Width', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr class="wpupg_divider">
        <td><span class="wpupg_label_prefix"><?php _e( 'Margin', 'wp-eultimate-post-grid' ); ?></span><label for="wpupg_pagination_style_margin_vertical"><?php _e( 'Vertical', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr>
        <td><label for="wpupg_pagination_style_margin_horizontal"><?php _e( 'Horizontal', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr>
        <td><span class="wpupg_label_prefix"><?php _e( 'Padding', 'wp-eultimate-post-grid' ); ?></span><label for="wpupg_pagination_style_padding_vertical"><?php _e( 'Vertical', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr>
        <td><label for="wpupg_pagination_style_padding_horizontal"><?php _e( 'Horizontal', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
    ...
    <tr class="wpupg_divider">
        <td><label for="wpupg_pagination_style_alignment"><?php _e( 'Alignment', 'wp-eultimate-post-grid' ); ?></label></td>
        <td>
