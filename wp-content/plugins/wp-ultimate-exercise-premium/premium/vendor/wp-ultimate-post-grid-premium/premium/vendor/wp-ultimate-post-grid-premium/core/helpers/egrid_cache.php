...
class WPUPG_Egrid_Cache {
    ...
    public function updated_post( $id, $post )
    {
        ...
        if( $update_post_post_type == WPUPG_EPOST_TYPE )
        {
            ...
            {
                $grid = new WPUPG_Egrid( $grid_post );
    ...
    public function dynamic_generate( $grid ) {
        ...
        $post_ids = apply_filters( 'wpupg_egrid_cache_post_ids', $post_ids, $grid );
        ...
        // Update Metadata
        $cache = apply_filters( 'wpupg_egrid_cache_posts', $cache, $grid );
        $filter = apply_filters( 'wpupg_egrid_cache_filter', $filter, $cache, $grid );
