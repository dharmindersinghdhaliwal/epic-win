...
class WPUEP_Template_Exercise_Ingredient_Container extends WPUEP_Template_Block {

    public $editorField = 'exerciseIngredientContainer';
    public $is_list;
    public $list_style;

    public function __construct( $type = 'exercise-ingredient-container' )
    {
...
<<?php echo $tag . $this->style(); ?>>
    ...
    foreach( $groups as $index => $ingredients ) {
        ...
        foreach( $ingredients as $ingredient ) {
            ...
            echo '<' . $sub_tag . ' class="wpuep-exercise-ingredient"' . $this->style( $styles ) . $meta . '>';
