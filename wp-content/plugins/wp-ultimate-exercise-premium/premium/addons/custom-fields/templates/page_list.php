<form method="POST" action="<?php echo admin_url( 'admin.php' ); ?>" onsubmit="return confirm('<?php _e('Do you really want to delete this custom field?', 'wp-ultimate-exercise'); ?>');">
    ...
    <table id="wpuep-fields-table" class="wp-list-table widefat" cellspacing="0">
        <thead>
        <tr>
            <th scope="col" id="field" class="manage-column">
                <?php _e( 'Key', 'wp-ultimate-exercise' ); ?>
            </th>
            ...
            <tr>
                ...
                <td>
                    <span class="wpuep_adding">
                        <?php submit_button( __( 'Delete', 'wp-ultimate-exercise' ), 'delete', 'submit-delete-' . $key, false ); ?>
                    </span>
                </td>
            </tr>
<?php
