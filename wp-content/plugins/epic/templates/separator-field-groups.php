<?php
    global $epic_admin;
    $epic_profile_fields = get_option('epic_profile_fields');

    $separator_group_fields = get_option('epic_separator_group_fields');

    $separator_fields = array();
    $profile_fields = array();
    if(is_array($epic_profile_fields)){
        foreach($epic_profile_fields as $profile_field){
...
<div class="epic-tab-content" id="epic-separator-field-groups-settings-content" style="display:none;">
    <h3><?php _e('Separator Field Groups Settings','epic');?>
        </h3>
        
        
    
    <div id="epic-separator-field-groups-settings" class="epic-custom-fields-screens" style="display:block">

        <form id="epic-separator-field-groups-settings-form">
            <table class="form-table" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <?php 
                                echo epic_Html::button('button', array('name'=>'save-epic-separator-groups-settings', 'id'=>'save-epic-separator-groups-settings', 'value'=> __('Save Changes','epic'), 'class'=>'button button-primary '));
                                echo '&nbsp;&nbsp;';
