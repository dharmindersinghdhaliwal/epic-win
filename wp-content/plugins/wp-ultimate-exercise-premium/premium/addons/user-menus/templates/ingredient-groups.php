<div class="wrap">
    <h2><?php _e( 'Ingredient Groups', 'wp-ultimate-exercise' ); ?></h2>
    ...
    foreach( $ingredients as $ingredient ) {
        $group = WPUEP_Taxonomy_MetaData::get( 'ingredient', $ingredient->slug, 'group' );
    ...
    <div class="ingredient-group-header">
        <div class="ingredient-group-input-container">
            <input type="text" id="newGroup" placeholder="<?php _e( 'Vegetables', 'wp-ultimate-exercise' ); ?>"><br/>
            <button class="button" onclick="IngredientGroups.setGroup(this)"><?php _e( 'Set group for selected ingredients', 'wp-ultimate-exercise' ); ?></button>
        </div>
    </div>
    ...
    echo __( 'Select', 'wp-ultimate-exercise' ) . ': ';
    echo '<span class="select-group-links">';
    echo '<a href="#" onclick="IngredientGroups.selectGroup(-1)">' . __( 'None', 'wp-ultimate-exercise' ) . '</a>, ';
    echo '<a href="#" onclick="IngredientGroups.selectGroup(0)">' . __( 'Ungrouped', 'wp-ultimate-exercise' ) . '</a>';
