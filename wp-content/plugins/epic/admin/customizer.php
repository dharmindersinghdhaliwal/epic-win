...
<a href="#epic-add-form" class="button button-secondary epic-toggle"><i
	class="epic-icon epic-icon epic-icon-plus"></i>&nbsp;&nbsp;<?php _e('Click here to add new field','epic'); ?>
</a>
...
<table class="form-table epic-add-form">
	...
	<tr valign="top">
		<th scope="row"></th>
		<td><input type="submit" name="epic-add" id="epic-add"
...
<table class="widefat fixed epic-table" cellspacing="0"
	id="epic-form-customizer-table">
	<thead>


		<tr class="ignore">
			<th class="manage-column column-columnname" scope="col" width="3%"><?php _e('Icon','epic'); ?>
			</th>

			<th class="manage-column column-columnname" scope="col"><?php _e('Label','epic'); ?><i
			...
			<th class="manage-column column-columnname" scope="col"><?php _e('Meta Key','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
				title="<?php _e('This is the meta field that stores this specific profile data (e.g. first_name stores First Name)','epic'); ?>"></i>
			</th>

			<th class="manage-column column-columnname" scope="col"><?php _e('Field Input','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
				title="<?php _e('This column tells you the field input that will appear to user for this data.','epic'); ?>"></i>
			</th>

			<th class="manage-column column-columnname " scope="col"><?php _e('Field Type','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
			...
			<th class="manage-column column-columnname" scope="col"><?php _e('Tooltip','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
			...
			<th class="manage-column column-columnname" scope="col"><?php _e('Social','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
			...
			<th class="manage-column column-columnname" scope="col"><?php _e('User can edit','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
				title="<?php _e('Allow or do not allow user to edit this field.','epic'); ?>"></i>
			</th>
			<th class="manage-column column-columnname" scope="col"><?php _e('Allow HTML','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
				title="<?php _e('If yes, users will be able to write HTML code in this field.','epic'); ?>"></i>
			</th>
			<th class="manage-column column-columnname" scope="col"><?php _e('User can hide','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
				title="<?php _e('Allow user to show/hide this profile field from public view.','epic'); ?>"></i>
			</th>
			<th class="manage-column column-columnname" scope="col"><?php _e('Private','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
				title="<?php _e('Only admins can see private fields.','epic'); ?>"></i>
			</th>
			<th class="manage-column column-columnname" scope="col"><?php _e('Required','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
				title="<?php _e('This is mandatory field for registration and edit profile.','epic'); ?>"></i>
			</th>
			<th class="manage-column column-columnname" scope="col"><?php _e('Show in Registration','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
				title="<?php _e('Show this field on the registration form? If you choose no, this field will be shown on edit profile only and not on the registration form. Most users prefer fewer fields when registering, so use this option with care.','epic'); ?>"></i>
			</th>
			<th class="manage-column column-columnname" scope="col"><?php _e('Edit','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
				title="<?php _e('Click to edit this profile field.','epic'); ?>"></i>
			</th>
			<th class="manage-column column-columnname" scope="col"><?php _e('Trash','epic'); ?><i
				class="epic-icon epic-icon-question-circle epic-tooltip"
	...
	<tfoot>
		<tr class="ignore">
			...
			<th class="manage-column column-columnname" scope="col"><?php _e('Icon','epic'); ?>
			</th>
	...
	<tbody>
		...
		<tr
			...
			<td class="column-columnname"><a href="#quick-edit" class="epic-edit"><i
		...
		<!-- edit field -->
		<tr class="epic-editor" id="value-editor-tr-<?php echo $pos; ?>">
			...
			<td class="column-columnname" colspan="3"><?php //if ($type != 'separator') { ?>
				...
				<p style="display:<?php echo $display_field_status; ?>">
					...
					</label> <select <?php echo $disabled_field_status; ?> name="epic_<?php echo $pos; ?>_can_hide"
						id="epic_<?php echo $pos; ?>_can_hide">
			...
			<td class="column-columnname" colspan="9"><?php if ($type != 'separator') { ?>
				...
				<p class="epic-choices <?php echo $show_choices; ?>">
					...
					<textarea  name="epic_<?php echo $pos; ?>_choices" type="text" id="epic_<?php echo $pos; ?>_choices" class="large-text"><?php if (isset($array['choices'])) echo trim($choices); ?></textarea>
					<i class="epic-icon epic-icon-question-circle epic-tooltip2"
