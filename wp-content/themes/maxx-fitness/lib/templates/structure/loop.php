 ...
 * @since 1.0.0
 */
do_action( 'maxxfitness_before_loop' );
	...
	if ( have_posts() && !is_404() ) :
		 ...
		 * @since 1.0.0
		 */
		do_action( 'maxxfitness_before_posts_loop' );
		...
		while ( have_posts() ) : the_post();
			...
			echo maxxfitness_open_markup( 'maxxfitness_post', 'article', $article_attributes );
				...
				echo maxxfitness_open_markup( 'maxxfitness_post_header', 'header' );
					 ...
					 * @since 1.0.0
					 */
					do_action( 'maxxfitness_post_header' );
				...
				echo maxxfitness_open_markup( 'maxxfitness_post_body', 'div' );
					 ...
					 * @since 1.0.0
					 */
					do_action( 'maxxfitness_post_body' );
		 ...
		 * @since 1.0.0
		 */
		do_action( 'maxxfitness_after_posts_loop' );
 ...
 * @since 1.0.0
 */
do_action( 'maxxfitness_after_loop' );
