...
*/
require_once('sweetalert/index.php');
...
final class DPA_Achievements_Loader {
	...
	public function register_post_types() {
		...
		$cpt['achievement'] = apply_filters( 'dpa_register_post_type_achievement', array(
			...
			'taxonomies'           => array( 'category','acategories' ),
		) );
		...
		$labels[ 'achievement_category' ] = array(
			'name' => _x( 'Achievement Categories', 'taxonomy general name', 'dpa' ),
			'singular_name' => _x( 'Acheivement Category', 'taxonomy singular name', 'dpa' ),
			'search_items' =>  __( 'Search Acheivement Categories', 'dpa' ),
			'all_items' => __( 'All Categories', 'dpa' ),
			'parent_item' => __( 'Parent Acheivement Category', 'dpa' ),
			'parent_item_colon' => __( 'Parent Acheivement Category:', 'dpa' ),
			'edit_item' => __( 'Edit Acheivement Category', 'dpa' ), 
			'update_item' => __( 'Update Acheivement Category', 'dpa' ),
			'add_new_item' => __( 'Add New Acheivement Category', 'dpa' ),
			'new_item_name' => __( 'New Acheivement Category Name', 'dpa' ),
			'menu_name' => __( ' Acheivement Categories', 'dpa' ),
		); 		
		
		// Register Achievement post type		
		register_post_type( dpa_get_achievement_post_type(), $cpt['achievement'] );		
		
		register_taxonomy('acategories',array( 'achievement' ), array(		
			'hierarchical' => true,			
			'labels' => $labels[ 'achievement_category' ],			
			'show_ui' => true,			
			'show_admin_column' => true,
			'query_var' => true,			
			'rewrite' => array( 'slug' => 'acategories' ),
		));
