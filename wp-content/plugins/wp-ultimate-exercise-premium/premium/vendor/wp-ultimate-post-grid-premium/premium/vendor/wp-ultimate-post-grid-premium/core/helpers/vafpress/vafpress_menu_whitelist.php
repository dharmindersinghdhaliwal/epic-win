...
{
    return !WPUltimateEPostEgrid::is_premium_active();
}
...
{
    if( WPUltimateEPostEgrid::is_addon_active( 'template-editor' ) ) {
        $url = WPUltimateEPostEgrid::addon( 'template-editor' )->editor_url();
