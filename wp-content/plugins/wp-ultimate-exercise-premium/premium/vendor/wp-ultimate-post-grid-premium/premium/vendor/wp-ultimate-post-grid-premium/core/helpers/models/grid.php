...
class WPUPG_Egrid {
    ...
    {
        return WPUltimateEPostEgrid::addon( 'custom-templates' )->get_template( $this->template_id() );
    }
    ...
    public function set_dynamic_rules( $dynamic_rules )
    {
        if( WPUltimateEPostEgrid::is_premium_active() ) {
            ...
            $generated = WPUltimateEPostEgrid::get()->helper( 'grid_cache' )->dynamic_generate( $this );
