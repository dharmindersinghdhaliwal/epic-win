					...
					<td>
						<fieldset>
							...
							<?php while ( dpa_achievements()) : ?>
								...
								<label><?php ?><input type="checkbox" name="dpa_user_achievements[]" value="<?php echo absint( dpa_get_the_achievement_ID() ); ?>" <?php checked( dpa_is_achievement_unlocked(), true ); ?>> <?php dpa_achievement_title(); ?></label><br>
							<?php endwhile; ?>
						</fieldset>
					</td>
				</tr>				
