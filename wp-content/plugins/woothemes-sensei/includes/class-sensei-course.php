...
class Sensei_Course {
	...
	public function __construct () {
        ...
        add_action( 'sensei_course_content_inside_after',array( $this, 'the_course_free_lesson_preview' ) );        // the course meta
...
//		remove_filter( 'posts_clauses', array( 'WooThemes_Sensei_Utils', 'get_posts_count_only_filter' ) );
	...
	public function course_lessons( $course_id = 0, $post_status = 'publish', $fields = 'all' ) {
        ...
        if( count( $lessons) > 1  ){
            ...
            $Sensei_Course_obj =	new Sensei_Course();
            uasort( $lessons, array( $Sensei_Course_obj, '_short_course_lessons_callback' )   );
        }
