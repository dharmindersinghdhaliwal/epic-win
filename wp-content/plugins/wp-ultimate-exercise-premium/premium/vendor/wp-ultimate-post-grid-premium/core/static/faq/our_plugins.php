<div class="changelog">
    ...
    <div class="feature-section col two-col">
        <div class="col-1">
            <img src="<?php echo $img_dir; ?>wp-ultimate-exercise.jpg" alt="WP Ultimate Exercise" class="about-overview-img" />
        </div>
        <div class="col-2 last-feature">
            <h3>WP Ultimate Exercise</h3>
            <p>The very best exercise plugin. Everything a food blog needs and more.</p>
            <p>
                Free & Premium plugin.
                <br/><a href="https://wordpress.org/plugins/wp-ultimate-exercise/" target="_blank">http://wordpress.org/plugins/wp-ultimate-exercise</a>
                <br/><a href="http://www.wpultimateexercise.com" target="_blank">http://www.wpultimateexercise.com</a>
            </p>
        </div>
    </div>
