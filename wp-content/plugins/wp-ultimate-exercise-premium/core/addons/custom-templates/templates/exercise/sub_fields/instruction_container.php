...
class WPUEP_Template_Exercise_Instruction_Container extends WPUEP_Template_Block {

    public $editorField = 'exerciseInstructionContainer';
    public $is_list;
    public $list_style;

    public function __construct( $type = 'exercise-instruction-container' )
    {
...
<<?php echo $tag . $this->style(); ?>>
    ...
    foreach( $groups as $index => $instructions ) {
        ...
        foreach( $instructions as $instruction ) {
            ...
            echo '<' . $sub_tag . ' class="wpuep-exercise-instruction"' . $this->style( $styles ) . '>';
