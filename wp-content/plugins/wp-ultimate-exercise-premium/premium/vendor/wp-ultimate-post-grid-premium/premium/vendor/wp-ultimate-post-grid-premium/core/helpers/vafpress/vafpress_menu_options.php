...
$sitehash = substr( md5( WPUltimateEPostEgrid::get()->coreUrl ), 0, 8 );

$template_editor_button = WPUltimateEPostEgrid::is_addon_active( 'template-editor' ) ? 'grid_template_open_template_editor_active' . $sitehash : 'grid_template_open_template_editor_disabled';

$admin_menu = array(
    'title' => 'WP Ultimate Post Egrid ' . __('Settings', 'wp-eultimate-post-grid'),
    'logo'  => WPUltimateEPostEgrid::get()->coreUrl . '/img/logo.png',
    'menus' => array(
//=-=-=-=-=-=-= GRID TEMPLATE =-=-=-=-=-=-=
        array(
            'title' => __('Egrid Template', 'wp-eultimate-post-grid'),
            'name' => 'grid_template',
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'label' => 'WP Ultimate Post Egrid Premium',
                            'description' => __('These features are only available in', 'wp-eultimate-post-grid') . ' <a href="http://bootstrapped.ventures/wp-eultimate-post-grid/" target="_blank">WP Ultimate Post Egrid Premium</a></strong>.',
                            'status' => 'warning',
                            'dependency' => array(
                                'field' => '',
                        ...
                        array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    ...
                                    'label' => __('Preview Egrid', 'wp-eultimate-post-grid'),
...
//=-=-=-=-=-=-= GRID =-=-=-=-=-=-=
        array(
            'title' => __('Egrid', 'wp-eultimate-post-grid'),
            'name' => 'grid',
        ...
        array(
            ...
            'controls' => array(
                array(
                    ...
                    'description' => '<a href="mailto:support@bootstrapped.ventures" target="_blank">WP Ultimate Post Egrid ' .__('FAQ & Support', 'wp-eultimate-post-grid') . '</a>',
                    'status' => 'info',
                ),
            ),
        ),
